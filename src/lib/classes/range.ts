...
// 	constructor(index: number, args: MRSRangeArgs, argHandler: ArgHandler) {
// 		this._index = index;
// 		this._args = args;
// 		this._args.size = this.size;
// 		this._argHandler = argHandler;
// 	}
...
// 	// validator getters/setter

// 	public get validatorArgs(): any {
// 		return this._argHandler.args;
// 	}

// 	// neighbor range getters

// 	public get previousRange(): MRSRange {
// 		return this.validatorArgs.ranges[this.index - 1];
// 	}
...
// 		return compareRange.allowContact && this.allowContact ? 0 : this.validatorArgs.step;
// 	}
...
// 			const { step, min, max, postData } = this.validatorArgs;
...
// 						input.name = `${this.validatorArgs.name}[${this.key}][start]`;
// 					}
...
// 						input.name = `${this.validatorArgs.name}[${this.key}][end]`;
// 					}
...
// 			const setTooltipModeAttribute = (mode: TooltipMode) => {
// 				switch (mode) {
...
// 			switch (tooltip) {
// 				case 'size':
// 					setTooltipModeAttribute(this.validatorArgs.tooltipMode.size);
// 					break;
// 				case 'start':
// 				case 'end':
// 					setTooltipModeAttribute(this.validatorArgs.tooltipMode.startEnd);
// 					break;
// 			}
...
// 			input.type = 'hidden';
// 			input.name = `${this.validatorArgs.name}[${this.key}][${postDataKey}]`;
...
// 		this.validatorArgs.postData.forEach((postDataKey: string) => {
...
// 					thumbWidth: number = this.validatorArgs.thumbWidth,
// 					sliderMin: number = this.validatorArgs.min,
// 					sliderMax: number = this.validatorArgs.max,
